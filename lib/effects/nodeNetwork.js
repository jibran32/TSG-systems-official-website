...
/**
 * The hero "constellation": drifting nodes joined by proximity lines, with
 * extra lines drawn toward the cursor. Colours are resolved per-theme each
 * frame so it stays legible on both white and dark backgrounds.
 *
 ...
 */
export function nodeNetwork({ animated = true } = {}) {
